...
"""השאילתה מבקשת להפיק נתונים על סך כל חטיפי השוקולד שנמכרו בשנת 2022 על ידי אנשי מכירות שהצטרפו לחברה בשנת 2010. השאילתה מחברת בין טבלת salesreps (נציגי מכירות) לטבלת orders (הזמנות) על בסיס עמודת srid (מזהה נציג מכירות). היא מסננת את הנתונים כך שיופיעו רק אנשי מכירות שהצטרפו בשנת 2010 וביצעו מכירות במהלך שנת 2022 (מוגדר בטווח תאריכים מ-1 בינואר עד 31 בדצמבר 2022). לאחר מכן, השאילתה מחשבת את סך כמות חטיפי השוקולד שנמכרו על ידי כל נציג מכירות ומציגה את שמם ואת סך הכמות שנמכרה. """
